(define-library (kons options)
  ...
  (begin
    (define scheme-implementations
      '("capy" "gauche" "gosh" "chibi" "chibi-scheme" "guile"
        "chez"
        "chezscheme"
        "sagittarius"
        "sash"
    ...
    (define-grammar kons-global-grammar
      ...
      (option "manifest"
        'help:
        "Path to kons.scm manifest file."
        'value-help:
        "FILE")
      (option "path"
        'help:
        "Package directory; kons.scm is read from PATH/kons.scm."
        'value-help:
        "DIR")
      (option "workspace-root"
        'help:
        "Workspace root manifest path (set internally for workspace members)."
        'value-help:
        "FILE"
        'hide?:
        #t)
      ...
      (option "compile-mode"
        'help:
        "Compilation mode for Capy and Guile."
        'value-help:
        "MODE"
        'allowed:
        compile-modes)
      (option "hook-scheme"
        'help:
        "Scheme implementation for build hooks (overridden by per-hook scheme-impl)."
        'value-help:
        "NAME"
        'allowed:
        scheme-implementations)
      ...
      (flag "no-color"
        'help:
        "Disable decorative colors and progress output."
        'negatable?:
        #f))
    ...
    (define-grammar kons-command-grammar
      ...
      (option "package"
        'help:
        "Workspace member package name or path."
        'value-help:
        "NAME")
      (separator "Implementation:")
      (option "scheme"
      ...
      (option "subpath"
        'help:
        "Subpath within a git dependency."
        'value-help:
        "PATH")
      (flag "no-default-features"
        'help:
      ...
      (flag "gc"
        'help:
        "Garbage-collect store artifacts.")
      (flag "store"
        'help:
        "Clean store artifacts.")
      (flag "dev"
        'help:
        "Use dev-dependencies scope.")
      (flag "system"
        'help:
        "Add or remove a system dependency.")
      (flag "lib"
        'help:
        "Create a library package starter.")
      (flag "raw"
        'help:
        "Add a raw dependency expression."))

...
(define (publish-grammar)
  (make-command-grammar
   (list 'option "registry"
         'help: "Registry alias or URL."
         'value-help: "REGISTRY")
   (list 'option "index"
         'help: "Registry API URL, accepted as a Cargo-compatible alias for --registry."
         'value-help: "URL")
   (list 'option "token"
         'help: "API token for this operation."
         'value-help: "TOKEN")
   (list 'flag "dry-run"
         'help: "Build and validate the publish payload without uploading.")
   (list 'flag "no-verify"
         'help: "Accepted for Cargo workflow compatibility.")
   (list 'flag "no-metadata"
         'help: "Do not require human-facing metadata.")
   (list 'flag "exclude-lockfile"
         'help: "Do not include kons.lock in the archive.")
...
(define (package-grammar)
  (make-command-grammar
   (list 'option "registry"
         'help: "Registry alias or URL used for package planning."
         'value-help: "REGISTRY")
   (list 'option "index"
         'help: "Registry API URL, accepted as a Cargo-compatible alias for --registry."
         'value-help: "URL")
   (list 'flag "list"
         'help: "Print files included in the package.")
   (list 'flag "no-verify"
         'help: "Accepted for Cargo workflow compatibility.")
   (list 'flag "no-metadata"
         'help: "Do not require human-facing metadata.")

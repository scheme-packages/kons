    ...
    (define (make-add-command runner)
      (make-kons-command
        ...
        (make-command-grammar
          ...
          (list 'option "rev"
            'help:
            "Git revision for path dependencies."
            'value-help:
            "REV")
          (list 'option "subpath"
            'help:
          ...
          (list 'option "version"
            'help:
            "Dependency version constraint. With --path or --git, records the registry requirement used for publish."
            'value-help:
            "VERSION")
          (list 'option "registry"
            'help:
            "Registry alias or URL for registry dependencies, or the publish registry for versioned local dependencies."
            'value-help:
            "REGISTRY")
          (list 'option "akku"
            'help:
